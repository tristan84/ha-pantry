...
1. In HACS → **⋮** → **Custom repositories**, add
   `https://github.com/trstan84/ha-pantry` as an **Integration**.
2. Install **My Pantry**, then **restart Home Assistant**.
3. Go to **Settings → Devices & Services → Add Integration → My Pantry** and
   press **Submit** (there's nothing to configure).
4. A **My Pantry** item appears in your sidebar. Done.
